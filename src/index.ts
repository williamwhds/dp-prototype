...
import { IHero } from './classes/IHero.js';
...
(function () {
  for (let f of heroes) console.log(f.toObject());
})();
...
(function () {
  for (let f of cloneHeroes) console.log(f.toObject());
})();
